...
author:
  - name: "Benjamin Moon & Chris Davie"
    url: 
...
```{r prerequisites}
here::i_am("labs/04_factorial-anova/help-yourself_assignment-3.Rmd")
...
###To Save the dataset as a .csv file, use the function below from the utils package. 
###Specify the data object (i.e., homunculi) and then the file name you want to export it 
###as (i.e., homunculi_dataset.csv. Make sure to include .csv at the end)

###write.csv(homunculi, "homunculi_dataset.csv")
